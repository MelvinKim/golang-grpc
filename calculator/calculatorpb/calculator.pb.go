...
func (x *FindMaximuRequest) Reset() {
	*x = FindMaximuRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindMaximuRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindMaximuRequest) ProtoMessage() {}

func (x *FindMaximuRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindMaximuRequest.ProtoReflect.Descriptor instead.
func (*FindMaximuRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{6}
}

func (x *FindMaximuRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x2b, 0x0a, 0x11, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2f,
	...
	0xfa, 0x02, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x53, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x4d,
	0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d, 0x12, 0x1d, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	0x74, 0x6f, 0x72, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x52, 0x65,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*FindMaximuRequest)(nil),                // 6: calculator.FindMaximuRequest
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	6, // 3: calculator.CalculatorService.FindMaximum:input_type -> calculator.FindMaximuRequest
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindMaximuRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
