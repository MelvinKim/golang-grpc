...
func (x *calculatorServiceFindMaximumClient) Send(m *FindMaximuRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
func (x *calculatorServiceFindMaximumServer) Recv() (*FindMaximuRequest, error) {
	m := new(FindMaximuRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
